    ...
    <footer className="footer sm:footer-horizontal bg-lime-300 text-base-content p-10">
      ...
      <div>
        ...
        <nav className="grid grid-cols-3 gap-4">
          <a href="/" className="flex gap-2 link link-hover">
            <House /> Home
          </a>
          <a href="/ideas" className="flex gap-2 link link-hover">
            <Lightbulb /> Ideas
          </a>
          <a href="/add-ideas" className="flex gap-2 link link-hover">
            <Plus /> Add Ideas
          </a>
          <a href="/my-ideas" className="flex gap-2 link link-hover">
            <User /> My Ideas
          </a>
          <a href="/my-interactions" className="flex gap-2 link link-hover">
